    ...
    partial class BootReceiver : BroadcastReceiver
    {
        ...
        public override void OnReceive(Context context, Intent intent)
        {
            ...
            {         // Start the service or activity
                context.ApplicationContext.StartService(new Intent(context, typeof(MyLocationService)));
            }
       ...
       // public object CrossGeolocator { get; private set; }
            ...
            if (locator.IsGeolocationEnabled && locator.IsGeolocationAvailable)
            {
                ...
                try
                {
                    ...
                    using (WebClient client = new WebClient())
                    {
                        ...
                        if (MyLocationService.notifications)
                        {
                            notification = builder.Build();
        ...
        void CheckLocationStatus(Object state)
        {
            ...
            if (locator.IsGeolocationEnabled && locator.IsGeolocationAvailable)
            {
                ...
                s.tmr.Dispose();
                s.tmr = null;
                System.TimeSpan locateFreq = new TimeSpan(120000);
                locator.StopListeningAsync();
                locator.StartListeningAsync(locateFreq, 0);

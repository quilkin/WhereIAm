...
namespace LocationService
{
	...
	public class LocationActivity : Activity
	{
		...
		{
            AppDomain currentDomain = AppDomain.CurrentDomain; currentDomain.UnhandledException += HandleExceptions;
        ...
        private void SetActions()
        {
            ...
            var notify = FindViewById<Button>(Resource.Id.checkNotify);
           ...
           // stop.Enabled = false;
            ...
            notify.Selected = MyLocationService.notifications;
            notify.Click += delegate
            {
                MyLocationService.notifications = !MyLocationService.notifications;
            };
        }
